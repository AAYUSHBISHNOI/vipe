        ...
        <div className="container mx-auto max-w-[1320px]">
            ...
            <div className=' flex flex-wrap justify-between pt-[20px] md:pt-[54px] pb-[50px] lg:pb-[129px]'>
                <div className='w-[100%] sm:w-[48%] lg:w-[31%]'>
                    <div className=' pt-[40px] pb-[38px] px-[18px] lg:h-[98%] flex flex-col items-center justify-center text-center rounded-[16px] border-[1px] border-[#e5e5e5] cursor-pointer hover:border-transparent boxShadow_5 duration-700'>
                        <Card1/>
                ...
                <div className='w-[100%] sm:w-[48%] lg:w-[31%] mt-5 sm:mt-0 '>
                    <div className=' pt-[40px] pb-[38px] px-[18px] h-[100%] lg:h-[98%] flex flex-col items-center justify-center text-center rounded-[16px] border-[1px] border-[#e5e5e5] cursor-pointer hover:border-transparent boxShadow_5 duration-700'>
                        <Card2/>
                        ...
                        <p className=' text-[#4d4d4d] text-[16px] font-normal ff_medium pt-[15px]'>Et nunc fermentum id amet tempus, <span className=' xl:block'>elementum. Eget ac ultrices tortor, mattis amet</span> <span className=' xl:block'>  blandit aenean amet. Massa diam lacus,</span><span className=' xl:block'>  aliquam neque, cursus.</span></p>
                        <ul>
                            <li><a href="" className=' font-semibold text-[16px] text-[#6022ea] ff_medium pt-[20px] relative after:left-[50%] after:absolute after:bg-[#6022ea] after:w-0 after:h-[3px] after:bottom-[-5px] hover:after:left-0 after:duration-700 inline hover:after:w-full'>Learn More</a></li>
                        </ul>
                    </div>
                ...
                <div className='w-[100%] sm:w-[48%] lg:w-[31%] mt-5 lg:mt-0 '>
                    <div className=' h-[400px] pt-[40px] pb-[18px] xl:pb-[40px] px-[18px] lg:h-[98%] flex flex-col items-center justify-center text-center rounded-[16px] border-[1px] border-[#e5e5e5] cursor-pointer hover:border-transparent boxShadow_5 duration-700'>
                        <Card3/>
